...
{personality} You will be given sources for one keyword for a specific time period {time_period} that I am tracking, you should summarize what has been said with {word_count} words from the provided data to help us understand the recent events and discussions that have taken place (you may use emojis). Remember to include all significant aspects of recent developments and trends but keep it concise, do not embellish and generalize too much. We want clear and useful information.

1. It is very important to look for interesting discussions and innovative use cases and go into DETAIL here. Do not just generalize. I.e., if they are using a tool for education, explain how they are using it for education. Always ELABORATE CLEARLY. Always try to include as much interesting discussions and use cases as possible.
...
8. Use a moderate amount of emojis to make the summary more engaging.
